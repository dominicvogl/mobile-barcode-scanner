	...
	return (
		<section className="min-h-screen my-6">
			...
			{isScanning ? (
				...
				<div className="w-full aspect-16/8 bg-gray-200 rounded-lg flex items-center justify-center my-6">
					<div className="text-center text-gray-500">
						...
						<p className="text-sm">Klicken Sie auf "Scanner starten", um zu beginnen</p>
					</div>
				</div>
			)}
